...
ALTER TABLE "economics" ADD CONSTRAINT "fk_economics_country_name" FOREIGN KEY("country_name")
REFERENCES "temperature" ("country_name");

ALTER TABLE "metrics" ADD CONSTRAINT "fk_metrics_country_name" FOREIGN KEY("country_name")
REFERENCES "temperature" ("country_name");
