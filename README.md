...
[ERD for database construction](url)
...
The map below shows the average of C02 emissions generated by different sectors during a period of years. This is one of the 3 maps that will be using to create a dashboard-viz switching  , so the user can choose between metrics and see changes in the map.
